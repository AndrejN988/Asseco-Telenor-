...
export class CategoryComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any, private transacionService : TransactionService, public formBuilder: FormBuilder, public dialogRef: MatDialogRef<CategoryComponent>) { }
